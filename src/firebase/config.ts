export const firebaseConfig = {
  ...
  appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID || "1:1061319966767:web:24cc91d57cf4c831d686da",
  measurementId: process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID || "G-HSDR60NWLX"
};
